...
from keras.layers import Input, Dense, Activation, Reshape, Flatten, Conv1D, MaxPooling1D, Dropout, LSTM, TimeDistributed, Bidirectional, LeakyReLU, concatenate, BatchNormalization, PReLU, AtrousConvolution1D
...
def build_model(input_shape, appliances):
    ...
    conv_2 = AtrousConvolution1D(40, 5, border_mode='same', atrous_rate=2)(drop_1)
...
#===============================================================================================
    ...
    conv_20 = AtrousConvolution1D(10, 15, border_mode='same', atrous_rate=2)(drop_10)
...
#===============================================================================================
    ...
    conv_21 = AtrousConvolution1D(10, 31, border_mode='same', atrous_rate=2)(drop_11)
...
#===============================================================================================
    ...
    conv_22 = AtrousConvolution1D(20, 11, border_mode='same', atrous_rate=2)(drop_12)
...
#===============================================================================================
    ...
    app_0 = Conv1D(filters=32, kernel_size=1, strides=1, padding=MODEL_CONV_PADDING)(concate_5)
    app_0 = BatchNormalization()(app_0)
    drop_7 = Dropout(0.22)(app_0)

    biLSTM_1 = Bidirectional(LSTM(32, dropout=0.1, recurrent_dropout=0.15, return_sequences=True))(drop_7)
    biLSTM_2 = Bidirectional(LSTM(32, dropout=0.1, recurrent_dropout=0.15, return_sequences=True))(biLSTM_1)

    outputs_disaggregation = []

    for appliance_name in appliances:
        biLSTM_3 = Bidirectional(LSTM(16, dropout=0.1, recurrent_dropout=0.15, return_sequences=True))(biLSTM_2)
